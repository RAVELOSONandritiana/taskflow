...
<tr class="hover:bg-gray-100">
	...
	<td class="max-w-xs truncate pl-4 text-sm text-gray-900">{title.split('-').slice(1).join(' ')}</td
	>
	<td class="pl-4">
			...
			>
				...
				{:else}
					<div class="relative flex items-center justify-center">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
							<path d="M 2 2 L 2 14 L 6 14 L 6 2 L 2 2 z M 10 2 L 10 14 L 14 14 L 14 2 L 10 2 z" />
						</svg>
					</div>
				{/if}
			</button>
