	...
	<div class="mx-10 md:mx-40">
		...
		>
			<div class="hidden h-full w-full lg:block">
				<img src={bglogin} alt="background login page" class="h-full w-full object-cover" loading="lazy"/>
			</div>
			<div class="space-y-4 self-start px-10 py-4 text-center">
				...
				<a href="/auth/login" class="float-left text-sm font-bold text-indigo-600"
					>forgot password?</a
				>
				<Button class="w-full rounded-sm">Log In</Button>
