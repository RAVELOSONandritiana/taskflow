...
<Banner class="grid place-items-center gap-y-12 py-2 md:px-20 lg:grid-cols-2 lg:py-6">
	<div class="order-2 space-y-6 text-center lg:order-1 lg:text-left">
		<div
		...
		>
			...
			<span class="font-semibold text-indigo-600 dark:text-indigo-400">Free to use.</span> No credit card
			required.
		</p>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mb-16 text-center">
			...
			<p class="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600 dark:text-gray-300">
				TaskFlow is designed to help you manage your projects efficiently and collaboratively with a
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
			...
			>
				...
				<p class="leading-relaxed text-gray-600 dark:text-gray-400">
					Work seamlessly with your team and share updates in real-time to keep everyone aligned and
					moving forward.
				</p>
			</div>
			<!-- Feature 3 -->
			...
			>
				...
				<p class="leading-relaxed text-gray-600 dark:text-gray-400">
					Your data is protected with enterprise-grade security measure to ensure your privacy and
					safety.
				</p>
			</div>
		</div>
		...
		<div class="grid items-center gap-16 lg:grid-cols-2">
			<div>
				...
				<p class="mt-6 text-lg text-gray-600 dark:text-gray-400">
					Everything you need to manage your projects from start to finish. Our toolset is designed
					for high-performance teams.
				</p>
				<dl class="mt-10 space-y-8">
					<div class="relative pl-12">
						<dt class="flex items-center gap-3 text-lg font-bold text-gray-900 dark:text-white">
							<div
			...
			<div class="grid grid-cols-2 gap-4">
				<div class="space-y-4">
					...
					>
						...
						<div class="text-sm font-medium text-gray-600 dark:text-gray-400">Sync & Updates</div>
					</div>
				</div>
				<div class="space-y-4 pt-8">
					...
					>
						...
						<div class="text-sm font-medium text-gray-600 dark:text-gray-400">Expert Support</div>
					</div>
					<div
						class="flex aspect-square flex-col items-center justify-center rounded-3xl border border-indigo-500/20 bg-indigo-500/10 p-6 text-center"
					>
						<div class="mb-2 text-4xl font-black text-indigo-600">10k+</div>
						<div class="text-sm font-medium text-gray-600 dark:text-gray-400">Active Users</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
			...
			>
				...
				<div class="flex items-center gap-4">
					<div class="h-12 w-12 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500"></div>
					<div>
			...
			>
				<div class="mb-6 text-indigo-500 italic">
					"The collaboration features in TaskFlow are outstanding. Our team is more productive than
					ever before."
				</div>
				<div class="flex items-center gap-4">
					<div class="h-12 w-12 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-500"></div>
					<div>
			...
			>
				<div class="mb-6 text-indigo-500 italic">
					"TaskFlow's real-time tracking and reporting have given us unprecedented visibility into
					our projects. Highly recommended!"
				</div>
				<div class="flex items-center gap-4">
					<div class="h-12 w-12 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500"></div>
					<div>
		...
		<div class="space-y-4">
			...
			>
				...
				<div class="px-6 pb-6 leading-relaxed text-gray-600 dark:text-gray-400">
					Getting started is easy! Simply sign up for a free account, create your first project, and
					start adding tasks. Our intuitive interface will guide you through the process
					step-by-step.
				</div>
			</details>
			<details
			...
			>
				...
				<div class="px-6 pb-6 leading-relaxed text-gray-600 dark:text-gray-400">
					Absolutely! TaskFlow is designed to scale with your team, whether you're a small startup
					or a large enterprise. Our collaboration features ensure everyone stays on the same page
			...
			>
				...
				<div class="px-6 pb-6 leading-relaxed text-gray-600 dark:text-gray-400">
					Yes, TaskFlow offers integrations with popular tools like Slack, Google Drive, and more.
					We are constantly adding new integrations to help streamline your workflow.
				</div>
			</details>
		</div>
	</div>
